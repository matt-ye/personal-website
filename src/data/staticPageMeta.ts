...
export const staticPageMeta: StaticPageMeta[] = [
  {
    ...
    "jsonLdEn": {"行銷專欄 Marketing Column":"Marketing Column"},
  ...
  },
  {
    ...
    "ogTitleEn": "AppWorks Demo Day #32 (AW#32): 19 Startups | One More Step",
    "ogDescriptionEn": "AppWorks Demo Day #32 (AW#32) with Wistron: 19 startups analysed, the four AW#33 RFS themes (manufacturing AI, defence, on-chain finance, post-quantum cryptography), a founder-credibility and moat matrix, and a read on where the next wave is heading.",
    "ogType": "article",
    "ogImage": "https://mattye.dev/og-logo.png",
  ...
  },
  {
    ...
    "ogTitleEn": "Four Competence Formulas — One More Step",
    "ogDescriptionEn": "Takeaways from Daniel Tseng, President of Corning Greater China: four career formulas, Boss vs Leader, North Star thinking, and three speaking techniques.",
    "ogType": "article",
    "ogImage": "https://mattye.dev/og-logo.png",
  ...
  },
  {
    ...
    "ogTitleEn": "GA4 Complete Guide",
    "ogDescriptionEn": "A complete GA4 walkthrough: funnel analysis, user behaviour, marketing applications, bot detection and advanced features.",
    "ogType": "article",
    "ogImage": "https://mattye.dev/og-logo.png",
  ...
  },
  {
    ...
    "descriptionEn": "Taiwan market notes plus a US guide to valuation, financial statements and metrics — margin buying, chip data, institutions, options, convertible bonds.",
    "ogTitleEn": "Taiwan × US Stock Investing Knowledge Base",
    "ogDescriptionEn": "Taiwan market notes plus a US guide to valuation, financial statements and metrics — margin buying, chip data, institutions, options, convertible bonds.",
    "ogType": "article",
    "ogImage": "https://mattye.dev/og-logo.png",
